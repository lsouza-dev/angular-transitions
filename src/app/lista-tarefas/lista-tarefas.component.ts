...
import { checkButtonTrigger, filterTrigger, formButtonTrigger, highlitedStateTrigger, listStateTrigger, semTarefasTrigger, shakeTrigger, shownStateTrigger } from '../animations';
